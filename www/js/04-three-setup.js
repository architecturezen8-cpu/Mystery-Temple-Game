...
function initThreeJS() {
    ...
    const maxPR = window.__PIXEL_RATIO_MAX__ || perf.maxPixelRatio || (isLowEnd ? 1.5 : 2);
...
function createStarField() {
    const perf = window.PERFORMANCE_PROFILE || {};
    // Keep full star count for all devices - quality first!
    const starCount = perf.isTablet ? 400 : (isLowEnd ? 350 : 500);
    ...
    // Colored stars
    const coloredStarCount = perf.isTablet ? 65 : (isLowEnd ? 50 : 80);
